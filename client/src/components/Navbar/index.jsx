...
const MobileNav = ({
  ...
  return (
    <div className="flex w-full items-center justify-between lg:hidden">
      <Link to="/delivery" className="w-28">
        <img
      ...
      <div className="flex items-center gap-3 relative">
        {user?.fullName ? (
          <>
            ...
            {isDropdownOpen && (
              <div className="absolute shadow-lg py-3 -bottom-14 -right-12 w-36 z-20 flex flex-col gap-2 bg-white border border-gray-200">
                <button onClick={SignOut}>Sign Out</button>
              </div>
            )}
          </>
          ...
          <>
            ...
            {isDropdownOpen && (
              <div className="absolute shadow-lg py-3 -bottom-24 -right-12 w-36 z-20 flex flex-col gap-2 bg-white border border-gray-200">
                <button onClick={SignIn}>Sign In</button>
                <button onClick={SignUp}>Sign Up</button>
              </div>
            )}
