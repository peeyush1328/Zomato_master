  ...
  return (
    <div className="w-full">
      <div className="lg:flex justify-between items-center hidden">
        <h3 className="font-normal text-lg px-2 pb-2 text-slate-500">
          Explore curated lists of top restaurants, cafes, pubs, and bars in
          Moradabad, based on trends
        </h3>
        <div className=" items-center justify-between pr-2 hidden lg:flex">
          <h4 className="text-zomato-300 text-base">
            All collections in Moradabad
          </h4>
          <BsFillCaretRightFill className="text-zomato-300 " />
        </div>
      </div>
      <Swiper {...slideConfig}>
